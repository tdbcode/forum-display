...
* lambda-nodejs18.x:StockTradingStateMachine
* lambda-nodejs18.x:StockCheckerFunction (nodejs18.x)
* lambda-nodejs18.x:StockSellerFunction (nodejs18.x)
* lambda-nodejs18.x:StockBuyerFunction (nodejs18.x)
* lambda-nodejs18.x:TransactionTable
